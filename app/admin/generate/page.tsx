...
import { LayoutTemplate, Key, AlertCircle, X } from 'lucide-react';
...
export default function GeneratePage() {
  ...
  return (
    <div className="space-y-8">
      ...
      {showApiKeyError && (
        <div className="bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800 p-4 rounded-xl flex items-start gap-3 shadow-sm animate-in zoom-in-95 duration-200">
