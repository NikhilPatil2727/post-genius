              ...
              {error && (
                ...
                >
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <p className="text-base font-bold text-red-600">Generation Failed</p>
                  </div>
                ...
                <div className="bg-zinc-900 dark:bg-white text-white dark:text-zinc-900 p-4 rounded-2xl shadow-2xl flex items-center justify-between border border-white/10 dark:border-zinc-200">
                    <div className="flex items-center gap-4">
                        ...
                        <div className="flex flex-col">
                            <span className="text-sm font-bold">Crafting Content</span>
                            <span className="text-[10px] opacity-70 font-medium font-mono uppercase tracking-tighter">AI-Streaming in progress...</span>
                        </div>
                    </div>
